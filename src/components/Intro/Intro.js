  ...
  useEffect(() => {
    const fetchPosts = async () => {
      const response = await axios.get(
        "https://life-and-balance.herokuapp.com/api/recent",
      );
    ...
    <div className="intro">
      ...
      <div className="second-section">
        <p>
          ...
          carries the message of hope and inspiration. It is a vital part of our
          existence that contributes to our physical, spiritual, and
        ...
        <p>
          ...
          mental health/illness. An estimated one in five Americans will receive
          a mental health diagnosis at some point in their lives. Unfortunately,
      ...
      <div className="fourth-section">
        ...
        <div id="mc_embed_signup" className="email-subscription">
          <form
            action="https://family3f1s.us14.list-manage.com/subscribe/post?u=a8d506e0336078361bb54024b&amp;id=a0b61fafc0"
            method="post"
          ...
          >
            <div id="mc_embed_signup_scroll">
              ...
              >
                <input
                  type="text"
                  name="b_a8d506e0336078361bb54024b_a0b61fafc0"
                  tabIndex="-1"
                />
              </div>
