...
const EventAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (file) {
      ...
      try {
        await axios.post("https://life-and-balance.herokuapp.com/api/upload", data)
      } catch (error) {
        console.log(error)
      }
    }
    try {
      const res = await axios.post('https://life-and-balance.herokuapp.com/api/events', newEvent)
